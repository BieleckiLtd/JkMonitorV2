...
builder.Services.AddSingleton<JkMonitor.Backend.Services.IDevicePollingClient>(sp => sp.GetRequiredService<JkMonitor.Backend.Services.GenericModbusPollingClient>());
