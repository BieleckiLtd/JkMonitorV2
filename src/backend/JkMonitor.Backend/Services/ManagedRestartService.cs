...
{
    private const string ServiceName = "jkmonitor.service";
    ...
    public bool IsManagedInstall
    {
        get
        {
            ...
            return File.Exists(Path.Combine(installRoot, "start.sh")) ||
                   ...
                   File.Exists(Path.Combine(installRoot, "jkmonitor.env"));
        }
    }
    ...
    public string GetApplyMessage()
    {
        ...
        {
            return "Saving from the app will restart the managed JK Monitor service automatically.";
        }
    ...
    public void ScheduleRestart()
    {
        ...
        if (IsLinuxServiceInstall())
        {
            logger.LogInformation("Scheduling application stop so systemd can restart JK Monitor.");
            _ = Task.Run(async () =>
            {
    ...
    public string? GetEnvironmentFilePath()
    {
        ...
        return Path.Combine(installRoot, "jkmonitor.env");
    }
