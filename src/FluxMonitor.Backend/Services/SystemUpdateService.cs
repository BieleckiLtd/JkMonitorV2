    ...
    ILogger<SystemUpdateService> logger)
{
    ...
    [
        ...
        new(
            ...
            CancelUnavailableReason: "Cancellation is no longer available because the new installation is being finalized."),
        new(
            InstallerSection: "Configuring local hostname discovery",
            Stage: "Checking local hostname discovery…",
            Detail: "Installing and starting Avahi so the device can advertise its .local hostname.",
            StepIndex: 10,
            StepCount: 12,
            PercentComplete: 90,
            CanCancel: false,
